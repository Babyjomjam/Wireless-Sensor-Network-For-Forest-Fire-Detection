...
//16.577423, 100.884654   s2 ทุ่งแสลงหลวง
float latitude = 16.577423;
float longitude =  100.884654;
...
void loop() {
  if (Firebase.ready() && signupOK && (millis() - sendDataPrevMillis > sendDataIntervalMillis || sendDataPrevMillis == 0)) {
    ...
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor2/temperature", temperature);
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor2/humidity", humidity);
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor2/gas", gas);
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor2/pressure", pressure);
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor2/altitude", altitude);
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor2/latitude", latitude);
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor2/longitude", longitude);
    Firebase.RTDB.setString(&fbdo, "Test1/sensor2/timestamp", timestamp); // บันทึก timestamp ลงใน Firebase
