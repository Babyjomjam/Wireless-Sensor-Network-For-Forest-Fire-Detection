...
//16.576233, 100.883959   s3 ทุ่งแสลงหลวง
float latitude = 16.576233;
float longitude =  100.883959;
...
void loop() {
  if (Firebase.ready() && signupOK && (millis() - sendDataPrevMillis > sendDataIntervalMillis || sendDataPrevMillis == 0)) {
    ...
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor3/temperature", temperature);
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor3/humidity", humidity);
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor3/gas", gas);
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor3/pressure", pressure);
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor3/altitude", altitude);
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor3/latitude", latitude);
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor3/longitude", longitude);
    Firebase.RTDB.setString(&fbdo, "Test1/sensor3/timestamp", timestamp); // บันทึก timestamp ลงใน Firebase
