...
//16.574946, 100.884151   s1 ทุ่งแสลงหลวง
float latitude = 16.574946;
float longitude =  100.884151;
...
void loop() {
  if (Firebase.ready() && signupOK && (millis() - sendDataPrevMillis > sendDataIntervalMillis || sendDataPrevMillis == 0)) {
    ...
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor1/temperature", temperature);
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor1/humidity", humidity);
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor1/gas", gas);
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor1/pressure", pressure);
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor1/altitude", altitude);
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor1/latitude", latitude);
    Firebase.RTDB.setFloat(&fbdo, "Test1/sensor1/longitude", longitude);
    Firebase.RTDB.setString(&fbdo, "Test1/sensor1/timestamp", timestamp); // บันทึก timestamp ลงใน Firebase
